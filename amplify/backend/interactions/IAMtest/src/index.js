    ...
    let intentParams = [
        
        {
            ...
            "confirmationPrompt": {
                ...
                "messages": [
                    {
                        "content": "Do you want to continue talking about {feelings}?", 
            ...
            "rejectionStatement": {
                "messages": [
                    {
                    "content": "Alright :) We can talk about something else, whenever you're ready. ", 
                    "contentType": "PlainText"
                    }
                ]
            }, 
            ...
            "fulfillmentActivity": {
                ...
                "codeHook": {
                    "messageVersion": "1.0",
                    "uri": "arn:aws:lambda:us-west-2:902317595156:function:checkSentiment"
                }
            }, 
            ...
            "slots": [
                ...
                
                {
                    ...
                    "valueElicitationPrompt": {
                        ...
                        "messages": [
                            {
                                "content": "Okay :) I'm listening-- what do you think about {subject}?",
                                "contentType": "PlainText"
                            }
                        ]
                    }
            ...
            "slots": [
                
                {
                    ...
                    "valueElicitationPrompt": {
                        ...
                        "messages": [
                            {
                                "content": "Well, thanks for opening up to me. :) It left a mark on me. I'm so sorry, but remind me what's your name again? ",
                                "contentType": "PlainText"
                            }
                        ]
                    }
...
function ensureLambdaFunctionAccess(intent){
    if(intent.fulfillmentLambda){
        ...
        const params = {
            ...
            StatementId: `Lex-${intent.name}`+ "cd858933",
